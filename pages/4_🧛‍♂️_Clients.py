...
with st.container():
    ...
    with col_1:
        st.image("images/client_logos/iit_logo.png", width=100)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/nptel.jpeg", width=170)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/nms_logo.png", width=150)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/dealsplus.png", width=150)
    with col_2:
        st.write(
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/amararaja_logo.png", width=140)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/pedaleze_logo.png", width=150)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/precision_logo.png", width=200)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/deeta_logo.webp", width=150)
    with col_2:
...
with st.container():
    col_1, col_2 = st.columns((1, 2))
    with col_1:
        st.image("images/client_logos/myrmc_logo.png", width=150)
    with col_2:
